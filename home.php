      ...
      <div class="container-fluid">
        <div class="row align-items-center">
          <div class="col-11 col-xl-2">
            <h1 class="mb-0"><a href="home.php" class="text-white h2 mb-0">Work<span class="text-primary">shop</span> </a></h1>
          </div>
          <div class="col-12 col-md-10 d-none d-xl-block">
            <nav class="site-navigation position-relative text-right" role="navigation">
              <ul class="site-menu js-clone-nav mx-auto d-none d-lg-block">
                ...
                <li><a href="indexform.php">Upload files</a></li>
                <li class="cta"> <a href="index.php?logout='1'" >logout</a></li>
      ...
      <div class="container">
        <div class="row align-items-center">
          <div class="col-md-10">
            ...
            <h1 class="d-block mb-4" data-aos="fade-up" data-aos-delay="200">Conference, Symposium and Museum Exhibitions 2020</h1>
             <h5 class="d-block mb-5 caption" data-aos="fade-up" data-aos-delay="300">
              <li>Conference: October 31 - November 1: 
                  5-21 Fukuromachi, Naka-ku, Hiroshima, Japan</li>
              <li>Exhibition: October 26 - November 6:
                  5-21 Fukuromachi, Naka-ku, Hiroshima, Japan</li>
              <li>Symposium: November 3: 
                  1 Chome-5-3 Otemachi, Naka-ku, Hiroshima, Japan</li></h5>
            <!--
      ...
      <div class="container">
        <div class="row mb-5">
          ...
          <div class="col-lg-5 mt-5 pl-lg-5" data-aos="fade-up" data-aos-delay="200">
            <p>You can write any thing here about the speakers.</p>
          </div>
        </div>
        ...
        <div class="row align-items-center speaker">
          ...
          <div class="col-lg-6 ml-auto">
            <h2 class="text-white mb-4 name" data-aos="fade-right" data-aos-delay="200">John Mensing</h2>
            <div class="bio pl-lg-5">
              <span class="text-uppercase text-primary d-block mb-3" data-aos="fade-right" data-aos-delay="300">Journalist</span>
              <p class="mb-4" data-aos="fade-right" data-aos-delay="400">Description about the speaker goes here...</p>
      ...
      <div class="container">
        <div class="row mb-5">
          ...
          <div class="col-lg-6 mt-5 pl-lg-5" data-aos="fade-up" data-aos-delay="100">
            <p>Program details shall come here, ask John.</p>
          </div>
        </div>
        ...
        <div class="row align-items-stretch program">
          <div class="col-12 border-top border-bottom py-5" data-aos="fade" data-aos-delay="200">
            <div class="row align-items-stretch">
              ...
              <div class="col-md-9">
                <h2 class="text-white">Presentation Title goes here...</h2>
                <span>John Mensing</span>
              </div>
            </div>
          </div>
    ...
    <div class="site-section">
      <div class="container">
        <div class="row mb-5">
          ...
          <div class="col-lg-6 mt-5 pl-lg-5" data-aos="fade-up" data-aos-delay="100">
            <p>Sponsors description goes here... John shall give the content.</p>
          </div>
        </div>
        <div class="row mb-5">
    ...
    <div class="site-section">
      <div class="container">
        <div class="row mb-5">
          ...
          <div class="col-lg-6 mt-5 pl-lg-5" data-aos="fade-up" data-aos-delay="100">
            <p>News Items go here... ask John for news items.</p>
          </div>
        </div>
        ...
        <div class="row mb-5">
          <div class="col-md-6 col-lg-4 mb-5 mb-lg-0 blog-entry"  data-aos="fade-up" data-aos-delay="200">
            ...
            <h2 class="mb-4"><a href="#">News Item Title goes here...</a></h2>
            <div class="mb-4 post-meta d-flex align-items-center">
              ...
              <div><span>By <a href="#">John Mensing</a></span> &mdash; <span>Jan. 10, 2020</span></div> 
            </div>
            <p>News content goes here...
          </div>
      ...
      <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-12 text-center">
              ...
              <p>
              Copyright &copy; <script>document.write(new Date().getFullYear());</script> All rights reserved. Designed and developed by <a href="http://www.ramtej.com" target="_blank"> RAMTEJ Technologies Corp.</a>
              </p>
            </div>
          </div>
        </div>
